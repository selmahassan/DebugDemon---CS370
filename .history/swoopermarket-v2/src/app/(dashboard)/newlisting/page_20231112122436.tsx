...
export default function StarredPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const listing = {
      // It's safer not to include the listingid in the request
      // Let the database generate a unique ID for the listing
    ...
    console.log(listing);
      ...
      const response = await fetch('/api/listing', {
        ...
        headers: {
          ...
          'Authorization': `Bearer ${token}`, // Uncomment if you're using the token from local storage
        },
