...
export async function getServerSideProps(context: Pick<NextPageContext, "req"> | { req: NextApiRequest; } | { req: express.Request; } | null | undefined): Promise<{ props: { user: UserProfile } } | { redirect: { destination: string, permanent: boolean } }> {
